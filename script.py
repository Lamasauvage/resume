...
for project, link in PROJECTS.items():
    if project == "Professional Title":
        ...
        st.markdown("🌐 Complete Website Development Project in PHP/Symfony with Database : [ACS Sport Santé](https://acs-sport-santé.fr)", unsafe_allow_html=True)
    ...
    elif project == "ScreenPairs":
        st.markdown("🎥 ScreenPairs : A Django-based web application with Python that finds common movies between two actors using The Movie Database (TMDb) API. [GitHub Repository](https://github.com/Lamasauvage/ScreenPairs)")
    elif link:
